...
from assets.service.base import BaseServiceList
...
class User(BaseServiceList):
    def __init__(self):
        ...
        condition_config = [
            ...
            {'name': 'is_admin', 'text': '管理员', 'condition_type': 'input'},
        ]
        # 表格的配置
        table_config = [
            {
            ...
            },
            {
                ...
                'title': "管理员",
                'display': 1,
                'text': {'content': "{n}", 'kwargs': {'n': '@is_admin'}},
                'attr': {'name': 'is_admin', 'id': '@is_admin', 'origin': '@is_admin', 'edit-enable': 'true',
                         'edit-type': 'input', }
            },
        ]
        # 额外搜索条件
